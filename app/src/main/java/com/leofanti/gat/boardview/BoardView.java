...
import com.leofanti.gat.boardview.BoardAdapter;
import com.leofanti.gat.boardview.BoardItem;
...
public class BoardView extends FrameLayout {
    ...
    public BoardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, com.allyants.boardview.R.styleable.BoardView,0,0);
        try {
            background_color = ta.getColor(com.allyants.boardview.R.styleable.BoardView_boardItemBackground, Color.TRANSPARENT);
        }finally{
            ta.recycle();
        }
    }
