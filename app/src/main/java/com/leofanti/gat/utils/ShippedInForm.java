...
public class ShippedInForm extends DialogFragment {

    public ShippedInForm() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.card_shipper_input, container, false);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == R.id.mpin_save) {
                    ...
                    if( !fechaGasto.isEmpty() && fechaGasto != null ){
                        expReg.setTimestamp(fechaGasto);
                    }
